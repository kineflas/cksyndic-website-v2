      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <article className="bg-white rounded-3xl shadow-2xl overflow-hidden">
          ...
          >
            ...
            <p className="text-xl text-primary-50">{article.metaDescription}</p>
          </div>
        ...
        <div className="mt-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {otherArticles.map((other) => (
              ...
              >
                <div
                  className="bg-gradient-to-br from-primary-600 to-primary-700 h-32 flex items-center justify-center"
                  style={{
                    background: 'linear-gradient(to bottom right, #2563eb, #1d4ed8)',
                    backgroundImage: 'linear-gradient(to bottom right, #2563eb, #1d4ed8)'
                  }}
